  ...
  return (
    ...
    <Navbar.Collapse id="navbarNavAltMarkup" className='w-100 h-100 align-items-start'>
        <div className="navbar-nav d-flex flex-column h-100 w-100 justify-content-between">
            ...
            <div>
                <Nav.Link className="nav-item nav-link align-items-center" href="#"><i className="far fa-arrow-alt-circle-down"></i>Install App</Nav.Link>
                <hr className="d-flex flex-wrap" />
                <Nav.Link className="nav-item nav-link align-items-center" href="#"><i className="fas fa-user"></i>Username</Nav.Link>
            </div>
        </div>
    </Navbar.Collapse>
</Navbar>
